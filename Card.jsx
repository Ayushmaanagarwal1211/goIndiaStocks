...
export default function Card({
  ...
  return (
    <div
      ...
      className={`w-[90%]   card flex flex-row ${
        index == "0" ? "mt-4" : "mt-8"
      } `}
    >
      <div className={`flex justify-center h-[30vh]  w-[25%] `}>
        <img
      ...
      <div className="  flex flex-col gap-5 pl-5 w-[75%]">
        <div className="flex flex-row w-[100%]  h-[auto] pl-5">
          <div className="h-[25%] w-[20%] ">Lorem Ipsum </div>
          <div className="w-[70%] flex justify-center">
            <button
              style={{
                backgroundColor: "#215575",
                borderRadius: "15px",
                minWidth: "45%",
              }}
              className={`text-wrap ${
          ...
          <div className="w-[auto]   " style={{ color: "#1b5d86" }}>
            2min read
          </div>
        </div>
        <p className="w-[100%] h-[auto] text-wrap">{description}</p>
        <div className="flex w-[100%] flex-row  ">
          <div
            style={{ width: "25%" }}
            className="w-[25%] flex flex-row items-center justify-center gap-5"
          >
            <FaHeart /> {likes}
          </div>
          <div
